...
(async () => {
  ...
  if (mode === "stills") {
    for (const H of [1920, 1350]) await stills(browser, H, [0.9, 5.6, 10.0, 14.0]);
  } else {
    await video(browser, 1920, "imp5-to-4800_9x16.mp4");
    await video(browser, 1350, "imp5-to-4800_4x5.mp4");
  }
  await browser.close();
