...
## 追加方針: 「あったらいいな」をAIで作るシリーズ

参考投稿:
https://www.instagram.com/p/DdWHxGxDTXN/?stkn=MWJiZ29qYzdxZnh1

実在しそうな架空の商品をAIでビジュアル化し、広告・仕様書のように見せる投稿を、
AIアカウントの新しい柱として追加する。
...
本人がADHD・LDの当事者である点を生かし、日常で実際に困っていることから
商品を考える。障害を説明するだけではなく、「困りごとをAIで形にする人」という
アカウントの独自性につなげる。
...
反応がよかった商品は、画像だけで終わらせず、アプリや簡単な試作品として
実際に作る。アイデア投稿から開発・検証企画へ接続する。

### 投稿文例

```text
ADHDの「何しようとしてたんだっけ」をなくす机。

作業を中断すると、その時点の画面と「次にやること」を机が記憶。
戻ってきたら続きから再開できます。
